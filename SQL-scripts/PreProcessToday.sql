...
/****** Object:  StoredProcedure [dbo].[PreProcessToday]    Script Date: 5/3/2016 9:01:16 AM ******/
...
CREATE NONCLUSTERED INDEX IX_today_stop_times_sec_1
...
(
	...
	FROM
		#today_stop_times_travel_time_sec cde -- cde is travel from b/c to d
...
CREATE NONCLUSTERED INDEX today_travel_time_benchmark_index_I
...
CREATE NONCLUSTERED INDEX IX_today_travel_time_benchmark_II
	...
	(
		...
		FROM
			(
				...
				FROM
					#today_stop_times_travel_time_sec att
					,dbo.config_time_slice
				WHERE 
...
CREATE NONCLUSTERED INDEX today_travel_time_threshold_index_I
...
SELECT 
	...
	FROM 
	dbo.today_travel_time_benchmark att
...
CREATE NONCLUSTERED INDEX today_headway_time_od_benchmark_index_I
	...
	(
		...
		FROM
			(
				...
				FROM
					#today_abcde_time_scheduled att
					,dbo.config_time_slice
				WHERE 
...
CREATE NONCLUSTERED INDEX today_wait_time_od_threshold_index_I
...
SELECT 
	...
	FROM 
	dbo.today_headway_time_od_benchmark aht
	,dbo.config_threshold th
	,dbo.config_threshold_calculation thc
	,dbo.config_mode_threshold mt
...
CREATE NONCLUSTERED INDEX today_headway_time_sr_all_benchmark_index_I
ON [dbo].[today_headway_time_sr_all_benchmark] ([stop_id],[direction_id])
INCLUDE ([time_slice_id],[scheduled_average_headway_sec])

CREATE NONCLUSTERED INDEX IX_today_headway_time_sr_same_benchmark_II
...
SELECT 
	...
	FROM 
	dbo.today_headway_time_sr_all_benchmark aht
	,dbo.config_threshold th
	,dbo.config_threshold_calculation thc
	,dbo.config_mode_threshold mt
...
CREATE NONCLUSTERED INDEX today_headway_time_sr_same_benchmark_index_I
ON [dbo].[today_headway_time_sr_same_benchmark] ([stop_id],[route_id],[direction_id])
INCLUDE ([time_slice_id],[scheduled_average_headway_sec])
