...
IF OBJECT_ID('ExcessJourneyTimeUsingAB','P') IS NOT NULL
	DROP PROCEDURE dbo.ExcessJourneyTimeUsingAB
...
CREATE PROCEDURE dbo.ExcessJourneyTimeUsingAB
...
IF OBJECT_ID('dbo.daily_journey_time_disaggregate_using_ab_time', 'U') IS NOT NULL
DROP TABLE dbo.daily_journey_time_disaggregate_using_ab_time

CREATE TABLE dbo.daily_journey_time_disaggregate_using_ab_time
	(
...
INSERT INTO dbo.daily_journey_time_disaggregate_using_ab_time
	(
		service_date
		,from_stop_id
		,to_stop_id
...
DELETE FROM dbo.historical_journey_time_using_ab_time
WHERE 
	service_date = @service_date_process	
	

INSERT INTO dbo.historical_journey_time_using_ab_time
	(	
		service_date
		,route_id
...
FROM
	dbo.daily_journey_time_disaggregate_using_ab_time
GROUP BY
	service_date
	,route_id	
