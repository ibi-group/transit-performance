...
IF OBJECT_ID('ExcessJourneyTimeScheduled','P') IS NOT NULL
	DROP PROCEDURE dbo.ExcessJourneyTimeScheduled
...
CREATE PROCEDURE dbo.ExcessJourneyTimeScheduled
...
IF OBJECT_ID('dbo.daily_journey_time_disaggregate_using_schedule', 'U') IS NOT NULL
DROP TABLE dbo.daily_journey_time_disaggregate_using_schedule

CREATE TABLE dbo.daily_journey_time_disaggregate_using_schedule
	(
...
INSERT INTO dbo.daily_journey_time_disaggregate_using_schedule
	(
		service_date
		,from_stop_id
		,to_stop_id
...
SELECT DISTINCT
	...
	,par.passenger_arrival_rate * (c_time_sec - a_time_sec)																		AS total_passengers
	,CASE	
		WHEN	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) <= 0					-- when max_excess_journey_time <= 0
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (1*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (1*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (1*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (2*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (2*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (2*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (3*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (3*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (3*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (4*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (4*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (4*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (5*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (5*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (5*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (6*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (6*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (6*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (7*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (7*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (7*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (8*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (8*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (8*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (9*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (9*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (9*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
	...
	,CASE	
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (10*60) <= 0		-- when max_excess_journey_time <= 0
		THEN 	0																												-- then passengers_with_excess_journey_time = 0
		WHEN 	(e_time_sec - a_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (10*60)  > 0
		AND 	(e_time_sec - c_time_sec) - (wt.expected_wait_time_sec + ivt.expected_in_vehicle_time_sec) - (10*60)  <= 0		-- when max_excess_journey_time > 0 and min_excess_journey_time <= 0
		THEN																											
				(
					(e_time_sec - a_time_sec) 
...
LEFT JOIN
	dbo.config_passenger_arrival_rate_b_branch_consolidated par
	ON
...
IF
	(
		SELECT 
			COUNT(*)
		FROM 
			dbo.historical_journey_time_using_schedule
		WHERE 
			service_date = @service_date_process
	)
		> 0

DELETE FROM dbo.historical_journey_time_using_schedule
WHERE 
	service_date = @service_date_process	
	

INSERT INTO dbo.historical_journey_time_using_schedule
	(	
		service_date
		,route_id
...
FROM
	dbo.daily_journey_time_disaggregate_using_schedule
GROUP BY
	service_date
	,route_id	
