...
IF OBJECT_ID('dbo.historical_vehicle_position_metrics_route','U') IS NOT NULL
	DROP TABLE dbo.historical_vehicle_position_metrics_route

CREATE TABLE dbo.historical_vehicle_position_metrics_route
(
