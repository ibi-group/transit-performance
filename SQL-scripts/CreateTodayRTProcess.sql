...
/****** Object:  StoredProcedure [dbo].[CreateTodayRTProcess]    Script Date: 8/17/2015 1:17:03 PM ******/
...
;
CREATE NONCLUSTERED INDEX today_rt_event_I
...
CREATE NONCLUSTERED INDEX today_rt_event_II
...
CREATE NONCLUSTERED INDEX today_rt_event_V
...
CREATE NONCLUSTERED INDEX today_rt_cd_time_index_I
...
(
		...
		,route_id				VARCHAR(255) NOT NULL
		,route_type				INT NOT NULL --ADDED
		,direction_id			INT NOT NULL
		,start_time_sec			INT NOT NULL
		,end_time_sec			INT NOT NULL
		,travel_time_sec		INT NOT NULL
		,benchmark_travel_time_sec	INT --ADDED
	)

--Create today_rt_headway_time_od_disaggregate. This table stores today's disaggregate heaway times at a stop between trips traveling to the same O-D pair in real-time
