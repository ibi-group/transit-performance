...
GO
CREATE NONCLUSTERED INDEX IX_rt_event_service_date ON rt_event(service_date);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_route_id ON rt_event(route_id);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_trip_id ON rt_event(trip_id);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_direction_id ON rt_event(direction_id);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_stop_id ON rt_event(stop_id);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_stop_sequence ON rt_event(stop_sequence);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_vehicle_id ON rt_event(vehicle_id);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_event_type ON rt_event(event_type);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_event_time ON rt_event(event_time);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_event_time_sec ON rt_event(event_time_sec);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_event_processed_rt ON rt_event(event_processed_rt);
GO
CREATE NONCLUSTERED INDEX IX_rt_event_event_processed_daily ON rt_event(event_processed_daily);
GO

CREATE NONCLUSTERED INDEX [IX_rt_event_index_1]
ON [dbo].[rt_event] ([service_date],[event_processed_rt])
INCLUDE ([record_id],[file_time],[route_id],[trip_id],[direction_id],[stop_id],[stop_sequence],[vehicle_id],[event_type],[event_time],[event_time_sec])
...
INCLUDE ([record_id],[file_time],[route_id],[trip_id],[direction_id],[stop_id],[stop_sequence],[vehicle_id],[event_type],[event_time],[event_time_sec],[event_processed_rt],[event_processed_daily])
*/

/*
-- create event_rt_trip and event_rt_trip archive tables to store latest predicted times for commuter rail
...
INCLUDE ([file_time],[route_id],[trip_id],[direction_id],[stop_id],[stop_sequence],[vehicle_id])
*/
...
CREATE NONCLUSTERED INDEX IX_historical_travel_time_disaggregate_1 ON dbo.historical_travel_time_disaggregate(from_stop_id,to_stop_id,direction_id,end_time_sec) INCLUDE (service_date,travel_time_sec)

CREATE NONCLUSTERED INDEX IX_historical_travel_time_disaggregate_2
ON [dbo].[historical_travel_time_disaggregate] ([from_stop_id],[to_stop_id],[route_type])
INCLUDE ([service_date],[route_id],[direction_id],[start_time_sec],[end_time_sec],[travel_time_sec],[benchmark_travel_time_sec])

CREATE NONCLUSTERED INDEX IX_historical_travel_time_disaggregate_3
...
CREATE NONCLUSTERED INDEX IX_historical_headway_time_od_disaggregate_1
ON dbo.historical_headway_time_od_disaggregate(stop_id,to_stop_id,direction_id,end_time_sec) INCLUDE (service_date,headway_time_sec)
...
INCLUDE ([to_stop_id],[route_id],[prev_route_id],[direction_id],[start_time_sec],[end_time_sec],[headway_time_sec],[benchmark_headway_time_sec],[route_type])
...
INCLUDE ([route_id],[prev_route_id],[direction_id],[start_time_sec],[end_time_sec],[headway_time_sec],[benchmark_headway_time_sec],[route_type])

CREATE NONCLUSTERED INDEX IX_historical_headway_time_sr_all_disaggregate_index_3
ON [dbo].[historical_headway_time_sr_all_disaggregate] ([service_date])


IF OBJECT_ID('dbo.historical_headway_time_sr_same_disaggregate','u') IS NOT NULL
...
CREATE NONCLUSTERED INDEX IX_historical_headway_time_sr_same_disaggregate_index_1
...
CREATE NONCLUSTERED INDEX IX_historical_headway_time_sr_same_disaggregate_index_2
ON [dbo].[historical_headway_time_sr_same_disaggregate] ([service_date],[stop_id])
INCLUDE ([route_id],[direction_id],[start_time_sec],[end_time_sec],[headway_time_sec],[benchmark_headway_time_sec],[prev_route_id],[route_type])

CREATE NONCLUSTERED INDEX IX_historical_headway_time_sr_same_disaggregate_index_3
...
CREATE NONCLUSTERED INDEX IX_historical_dwell_time_disaggregate_stop_id
ON [dbo].[historical_dwell_time_disaggregate] ([stop_id])
INCLUDE ([service_date],[route_id],[direction_id],[start_time_sec],[end_time_sec],[dwell_time_sec])

CREATE NONCLUSTERED INDEX IX_historical_dwell_time_disaggregate_service_id
...
(
		...
		,threshold_scheduled_median_travel_time_sec		INT NULL --ADDED
		...
		,historical_threshold_numerator_pax				FLOAT NULL --CHANGED
		,scheduled_threshold_numerator_pax				FLOAT NULL -- ADDED
		,denominator_trip								FLOAT NULL	--ADDED
		,historical_threshold_numerator_trip			FLOAT NULL		 --ADDED
		,scheduled_threshold_numerator_trip				FLOAT NULL	-- ADDED
	)
	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_from_stop_id ON historical_travel_time_threshold_pax(from_stop_id);

	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_to_stop_id ON historical_travel_time_threshold_pax(to_stop_id);

	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_prev_route_id ON historical_travel_time_threshold_pax(prev_route_id);

	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_route_id ON historical_travel_time_threshold_pax(route_id);

	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_direction_id ON historical_travel_time_threshold_pax(direction_id);

	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_end_time_sec ON historical_travel_time_threshold_pax(end_time_sec);
	
	CREATE NONCLUSTERED INDEX IX_historical_travel_time_threshold_pax_threshold_id ON historical_travel_time_threshold_pax(threshold_id);

	CREATE NONCLUSTERED INDEX [IX_historical_travel_time_threshold_pax_service_date] ON [dbo].[historical_travel_time_threshold_pax] ([service_date])
	...
	(
		...
		,threshold_scheduled_median_wait_time_sec	INT  NULL --ADDED
	...
	CREATE NONCLUSTERED INDEX IX_historical_wait_time_od_threshold_pax_from_stop_id ON historical_wait_time_od_threshold_pax(from_stop_id);

	CREATE NONCLUSTERED INDEX IX_historical_wait_time_od_threshold_pax_to_stop_id ON historical_wait_time_od_threshold_pax(to_stop_id);

	CREATE NONCLUSTERED INDEX IX_historical_wait_time_od_threshold_pax_prev_route_id ON historical_wait_time_od_threshold_pax(prev_route_id);

	CREATE NONCLUSTERED INDEX IX_historical_wait_time_od_threshold_pax_route_id ON historical_wait_time_od_threshold_pax(route_id);
	
	CREATE NONCLUSTERED INDEX IX_historical_wait_time_od_threshold_pax_direction_id ON historical_wait_time_od_threshold_pax(direction_id);

	CREATE NONCLUSTERED INDEX IX_historical_wait_time_od_threshold_pax_end_time_sec ON historical_wait_time_od_threshold_pax(end_time_sec);

	CREATE NONCLUSTERED INDEX [IX_historical_wait_time_od_threshold_pax_service_date] ON [dbo].[historical_wait_time_od_threshold_pax] ([service_date])
	...
	(
		...
		,metric_result		FLOAT	     
		,metric_result_trip	FLOAT --ADDED
		,numerator_pax		FLOAT --added
		,denominator_pax	FLOAT --added
		,numerator_trip		FLOAT --added
		,denominator_trip	FLOAT  --added
	)

	CREATE NONCLUSTERED INDEX IX_historical_metrics_service_date ON dbo.historical_metrics(service_date);
...
CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_route_id ON historical_schedule_adherence_disaggregate(route_id);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_direction_id ON historical_schedule_adherence_disaggregate(direction_id);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_stop_id ON historical_schedule_adherence_disaggregate(stop_id);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_actual_arrival_time_sec ON historical_schedule_adherence_disaggregate(actual_arrival_time_sec);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_actual_departure_time_sec ON historical_schedule_adherence_disaggregate(actual_departure_time_sec);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_1
ON [dbo].[historical_schedule_adherence_disaggregate] ([stop_id])
INCLUDE ([service_date],[route_id],[direction_id],[trip_id],[scheduled_arrival_time_sec],[actual_arrival_time_sec],[arrival_delay_sec],[scheduled_departure_time_sec],[actual_departure_time_sec],[departure_delay_sec],[stop_order_flag])

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_disaggregate_service_date ON dbo.historical_schedule_adherence_disaggregate (service_date)
...
CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_threshold_pax_route_id ON historical_schedule_adherence_threshold_pax(route_id);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_threshold_pax_stop_id ON historical_schedule_adherence_threshold_pax(stop_id);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_threshold_pax_direction_id ON historical_schedule_adherence_threshold_pax(direction_id);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_threshold_pax_actual_arrival_time_sec ON historical_schedule_adherence_threshold_pax(actual_arrival_time_sec);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_threshold_pax_actual_departure_time_sec ON historical_schedule_adherence_threshold_pax(actual_departure_time_sec);

CREATE NONCLUSTERED INDEX IX_historical_schedule_adherence_threshold_pax_service_date ON historical_schedule_adherence_threshold_pax(service_date);
*/
...
--
	...
	(
		...
		,threshold_scheduled_average_headway_time_sec	INT NOT NULL --added
		,denominator_trip								FLOAT NOT NULL --added
		,scheduled_threshold_numerator_trip				FLOAT NOT NULL --added
		)

	CREATE NONCLUSTERED INDEX IX_historical_headway_time_threshold_trip_stop_id ON historical_headway_time_threshold_trip(stop_id);

	CREATE NONCLUSTERED INDEX IX_historical_headway_time_threshold_trip_prev_route_id ON historical_headway_time_threshold_trip(prev_route_id);

	CREATE NONCLUSTERED INDEX IX_historical_headway_time_threshold_trip_route_id ON historical_headway_time_threshold_trip(route_id);
	
	CREATE NONCLUSTERED INDEX IX_historical_headway_time_threshold_trip_direction_id ON historical_headway_time_threshold_trip(direction_id);

	CREATE NONCLUSTERED INDEX IX_historical_headway_time_threshold_trip_service_date ON historical_headway_time_threshold_trip(service_date);
	*/
...
CREATE NONCLUSTERED INDEX config_passenger_od_load_CR_index_I
...
IF OBJECT_ID('dbo.threshold_calculation','U') IS NOT NULL
